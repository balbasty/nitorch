...
def gre(pd, r1, r2s=None, mt=None, transmit=None, receive=None, gfactor=None,
        te=0, tr=2.5e-3, fa=20, mtpulse=False, sigma=None, noise='rician',
    ...
    r2s : ParameterMap, optional
        Transverse relaxation rate. Mandatory if any `te > 0`.
    ...
    transmit = make_list(transmit, nb_contrasts)
    receive = make_list(receive, nb_contrasts)
    gfactor = make_list(gfactor, nb_contrasts)
    ...
    for n in range(nb_contrasts):
        ...
        if mtpulse1:
            ...
            flash /= (1 - cosfa * e1)
        del e1, omt, cosfa, fa1, f1r1, f1mt
