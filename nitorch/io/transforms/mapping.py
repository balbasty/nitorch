...
class MappedNonLin(MappedArray):
    """An nonlinear transform stored on disk"""
    ...
    def fdata(self, dtype=None, device=None, numpy=False):
        ...
        This function tries to return a displacment map, in "nonlinear voxels".
    ...
    def data(self, dtype=None, device=None, numpy=False):
        ...
        The "raw" data is loaded even if it does not conform to the
        `fdata()` convention. When known, its type is returned by the
        `type()` function.
        ...
        -------
        flow : (..., D) tensor or array
            Displacement field, or field of coordinates
        """
